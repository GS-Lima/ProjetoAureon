  ...
  return (
    ...
    className="w-screen h-16 min-h-[64px] flex items-center sm:flex justify-between sticky top-0 bg-white px-4 z-50 !pt-0 !pb-0">
      ...
      <div className="ml-4 mr-4 flex items-center">
        <a href="" className="border border-slate-400 p-2 rounded-md items-center flex">
        ...
        <a href="" className="border border-slate-400 p-2 rounded-md items-center  hidden sm:flex">
          <img src={favoriteIcon} alt="userIcon" className="h-4" />{" "}
        </a>
        <a href="" className="border border-slate-400 p-2 rounded-md items-center hidden sm:flex">
          <img src={cartIcon} alt="userIcon" className="h-4" />{" "}
        </a>
      </div>
    </div>
  );
